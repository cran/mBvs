...
void mzip_restricted2_updateRP_beta(int *p_adj,
                   gsl_matrix *Y,
                   gsl_matrix *X1,
                   gsl_vector *xi,
                   gsl_matrix *W,
...
void mzip_restricted2_updateRP_alpha(int *p_adj,
                    gsl_matrix *Y,
                    gsl_matrix *X0,
                    gsl_vector *alpha0,
                    gsl_matrix *A,
...
void mzip_restricted2_update_Sigma(gsl_matrix *X0,
                  gsl_vector *alpha0,
                  gsl_matrix *A,
                  gsl_matrix *W,
                  gsl_matrix *V,
                  ...
                  int *accept_R)
{
    ...
    c_riwishart(rho_s+ (double) q + 1, Sigma_scaled, Sigma_prop);
...
void mzip_restricted2_update_V(gsl_matrix *Y,
              gsl_matrix *X1,
              gsl_vector *xi,
              gsl_matrix *W,
              gsl_vector *beta0,
...
void mzip_restricted2_update_beta0(gsl_matrix *Y,
                  gsl_matrix *X1,
                  gsl_vector *xi,
                  gsl_matrix *W,
                  gsl_vector *beta0,
...
void mzip_restricted2_update_W(gsl_matrix *Y,
              gsl_matrix *X0,
              gsl_matrix *X1,
              gsl_vector *xi,
              gsl_vector *alpha0,
...
void mzip_restricted2_update_alpha0(gsl_matrix *X0,
                   gsl_vector *alpha0,
                   gsl_matrix *A,
                   gsl_matrix *W,
                   gsl_matrix *invR,
...
void mzip_restricted2_update_sigSq_alpha0(gsl_vector *alpha0,
                         double *sigSq_alpha0,
                         double a_alpha0,
                         double b_alpha0)
{
...
void mzip_restricted2_update_sigSq_beta0(gsl_vector *beta0,
                        double *sigSq_beta0,
                        double a_beta0,
                        double b_beta0)
{
...
void mzip_restricted2_update_sigSq_alpha(gsl_matrix *A,
                        gsl_matrix *gamma_alpha,
                        gsl_vector *sigSq_alpha,
                        gsl_vector *v_alpha,
                        gsl_vector *a_alpha,
                        gsl_vector *b_alpha)
{
    ...
    zeta_shape = gsl_vector_get(a_alpha, kk) + (double) numNZ/2;
...
void mzip_restricted2_update_sigSq_beta(gsl_matrix *B,
                       gsl_matrix *gamma_beta,
                       gsl_vector *sigSq_beta,
                       gsl_vector *v_beta,
                       gsl_vector *a_beta,
                       gsl_vector *b_beta)
{
    ...
    zeta_shape = gsl_vector_get(a_beta, kk) + (double) numNZ/2;
